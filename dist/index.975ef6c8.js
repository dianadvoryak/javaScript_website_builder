...
var _jscolor = require("@eastdesire/jscolor");
const model = [
    new (0, _blocks.TitleBlock)("JavaScript Website Builder", {
        tag: "h2",
        styles: {
    ...
    new (0, _blocks.TextBlock)("In the sidebar, you can adjust the size and color of the text, and the background color.", {
        styles: {
...
class TitleBlock extends Block {
    ...
    toHTML() {
        ...
        // console.log(styles)
        return (0, _utils.row)((0, _utils.col)(`<${tag} style="${(0, _utils.css)(fz)}">${this.value}</${tag}>`), (0, _utils.css)(styles));
    }
}
...
parcelHelpers.export(exports, "TitleHTML", ()=>TitleHTML);
parcelHelpers.export(exports, "TextHTML", ()=>TextHTML);
parcelHelpers.export(exports, "ColumnsHTML", ()=>ColumnsHTML);
 ...
 */ (function(global, factory) {
    ...
    factory(global);
})(typeof window !== "undefined" ? window : this, function(window1) {
    // BEGIN jscolor code
    "use strict";
    var jscolor = function() {
        var jsc = {
            ...
            readyQueue: [],
            register: function() {
                if (typeof window1 !== "undefined" && window1.document) window1.document.addEventListener("DOMContentLoaded", jsc.pub.init, false);
            },
            installBySelector: function(selector, rootNode) {
                rootNode = rootNode ? jsc.node(rootNode) : window1.document;
                if (!rootNode) throw new Error("Missing root node");
                var elms = rootNode.querySelectorAll(selector);
                // for backward compatibility with DEPRECATED installation/configuration using className
                var matchClass = new RegExp("(^|\\s)(" + jsc.pub.lookupClass + ")(\\s*(\\{[^}]*\\})|\\s|$)", "i");
                for(var i = 0; i < elms.length; i += 1){
                    if (elms[i].jscolor && elms[i].jscolor instanceof jsc.pub) continue; // jscolor already installed on this element
                    if (elms[i].type !== undefined && elms[i].type.toLowerCase() == "color" && jsc.isColorAttrSupported) continue; // skips inputs of type 'color' if supported by the browser
                    var dataOpts, m;
                    if ((dataOpts = jsc.getDataAttr(elms[i], "jscolor")) !== null || elms[i].className && (m = elms[i].className.match(matchClass)) // installation using className (DEPRECATED)
                        ...
                        var optsStr = "";
                        if (dataOpts !== null) optsStr = dataOpts;
                        else if (m) {
            ...
            parseOptionsStr: function(str) {
                ...
                try {
                    ...
                    else // loose JSON syntax is enabled -> try to evaluate the options string as JavaScript object
                    try {
            ...
            getInstances: function() {
                var inst = [];
                for(var i = 0; i < jsc.instances.length; i += 1)// if the targetElement still exists, the instance is considered "alive"
                if (jsc.instances[i] && jsc.instances[i].targetElement) inst.push(jsc.instances[i]);
                return inst;
            },
            createEl: function(tagName) {
                var el = window1.document.createElement(tagName);
            ...
            node: function(nodeOrSelector) {
                ...
                if (typeof nodeOrSelector === "string") {
                    ...
                    var el = null;
                    try {
                        el = window1.document.querySelector(sel);
                    } catch (e) {
                        console.warn(e);
                        return null;
                    }
                ...
                if (jsc.isNode(nodeOrSelector)) // DOM node
            ...
            isNode: function(val) {
                if (typeof Node === "object") return val instanceof Node;
                return val && typeof val === "object" && typeof val.nodeType === "number" && typeof val.nodeName === "string";
            },
            nodeName: function(node) {
                if (node && node.nodeName) return node.nodeName.toLowerCase();
                return false;
            },
            ...
            isPassiveEventSupported: function() {
                ...
                try {
                    ...
                    window1.addEventListener("testPassive", null, opts);
                    window1.removeEventListener("testPassive", null, opts);
                } catch (e) {}
                return supported;
            }(),
            isColorAttrSupported: function() {
                var elm = window1.document.createElement("input");
                if (elm.setAttribute) {
                    elm.setAttribute("type", "color");
                    if (elm.type.toLowerCase() == "color") return true;
                }
                return false;
            }(),
            ...
            setData: function() {
                ...
                if (arguments.length === 3) {
                    ...
                    var data = obj.hasOwnProperty(jsc.dataProp) ? obj[jsc.dataProp] : obj[jsc.dataProp] = {};
                    var map = arguments[1];
                    for(var prop in map)if (map.hasOwnProperty(prop)) data[prop] = map[prop];
                    return true;
                }
            ...
            removeData: function() {
                var obj = arguments[0];
                if (!obj.hasOwnProperty(jsc.dataProp)) return true; // data object does not exist
            ...
            getData: function(obj, prop, setDefault) {
                if (!obj.hasOwnProperty(jsc.dataProp)) {
                    ...
                    if (setDefault !== undefined) obj[jsc.dataProp] = {}; // create data object
                    else return undefined; // no value to return
                }
                var data = obj[jsc.dataProp];
                if (!data.hasOwnProperty(prop) && setDefault !== undefined) data[prop] = setDefault;
                return data[prop];
            },
            ...
            setDataAttr: function(el, name, value1) {
                var attrName = "data-" + name;
                el.setAttribute(attrName, value1);
            },
            _attachedGroupEvents: {},
            attachGroupEvent: function(groupName, el, evnt, func) {
                if (!jsc._attachedGroupEvents.hasOwnProperty(groupName)) jsc._attachedGroupEvents[groupName] = [];
                jsc._attachedGroupEvents[groupName].push([
                    el,
                    evnt,
                    func
                ]);
            ...
            triggerEvent: function(el, eventName, bubbles, cancelable) {
                if (!el) return;
                var ev = null;
                if (typeof Event === "function") ev = new Event(eventName, {
                    bubbles: bubbles,
                    cancelable: cancelable
                });
                else {
                    // IE
                    ev = window1.document.createEvent("Event");
            ...
            triggerInputEvent: function(el, eventName, bubbles, cancelable) {
                if (!el) return;
                if (jsc.isTextInput(el)) jsc.triggerEvent(el, eventName, bubbles, cancelable);
            },
            eventKey: function(ev) {
                ...
                if (typeof ev.code === "string") return ev.code;
                else if (ev.keyCode !== undefined && keys.hasOwnProperty(ev.keyCode)) return keys[ev.keyCode];
                return null;
            },
            ...
            addClass: function(elm, className) {
                ...
                // polyfill
                for(var i = 0; i < classNames.length; i += 1)if (!jsc.hasClass(elm, classNames[i])) elm.className += (elm.className ? " " : "") + classNames[i];
            },
            // The className parameter (str) can contain multiple class names separated by whitespace
            ...
            getCompStyle: function(elm) {
                var compStyle = window1.getComputedStyle ? window1.getComputedStyle(elm) : elm.currentStyle;
            ...
            setStyle: function(elm, styles, important, reversible) {
                ...
                var origStyle = null;
                for(var prop in styles)if (styles.hasOwnProperty(prop)) {
                    var setVal = null;
                    if (styles[prop] === null) {
                        // reverting a property value
                        if (!origStyle) // get the original style object, but dont't try to create it if it doesn't exist
                        origStyle = jsc.getData(elm, "origStyle");
                        if (origStyle && origStyle.hasOwnProperty(prop)) // we have property's original value -> use it
                        setVal = origStyle[prop];
                    } else {
                        // setting a property value
                        if (reversible) {
                            if (!origStyle) // get the original style object and if it doesn't exist, create it
                            origStyle = jsc.getData(elm, "origStyle", {});
                            if (!origStyle.hasOwnProperty(prop)) // original property value not yet stored -> store it
            ...
            hexColor: function(r, g, b) {
                return "#" + (("0" + Math.round(r).toString(16)).slice(-2) + ("0" + Math.round(g).toString(16)).slice(-2) + ("0" + Math.round(b).toString(16)).slice(-2)).toUpperCase();
            },
            hexaColor: function(r, g, b, a) {
                return "#" + (("0" + Math.round(r).toString(16)).slice(-2) + ("0" + Math.round(g).toString(16)).slice(-2) + ("0" + Math.round(b).toString(16)).slice(-2) + ("0" + Math.round(a * 255).toString(16)).slice(-2)).toUpperCase();
            },
            ...
            linearGradient: function() {
                function getFuncName() {
                    ...
                    var helper = window1.document.createElement("div");
            ...
            setBorderRadius: function(elm, value1) {
                jsc.setStyle(elm, {
                    "border-radius": value1 || "0"
                });
            },
            setBoxShadow: function(elm, value1) {
                jsc.setStyle(elm, {
                    "box-shadow": value1 || "none"
                });
            },
            ...
            getViewPos: function() {
                var doc = window1.document.documentElement;
                return [
                    (window1.pageXOffset || doc.scrollLeft) - (doc.clientLeft || 0),
                    (window1.pageYOffset || doc.scrollTop) - (doc.clientTop || 0)
                ];
            },
            getViewSize: function() {
                var doc = window1.document.documentElement;
                return [
                    window1.innerWidth || doc.clientWidth,
                    window1.innerHeight || doc.clientHeight
                ];
            },
            // r: 0-255
            // g: 0-255
            ...
            parsePaletteValue: function(mixed) {
                var vals = [];
                if (typeof mixed === "string") // rgb() and rgba() may contain spaces too, so let's find all color values by regex
                mixed.replace(/#[0-9A-F]{3}\b|#[0-9A-F]{6}([0-9A-F]{2})?\b|rgba?\(([^)]*)\)/ig, function(val) {
                    vals.push(val);
                });
                else if (Array.isArray(mixed)) vals = mixed;
            ...
            redrawPosition: function() {
                if (!jsc.picker || !jsc.picker.owner) return; // picker is not shown
                var thisObj = jsc.picker.owner;
                if (thisObj.container !== window1.document.body) jsc._drawPosition(thisObj, 0, 0, "relative", false);
                else {
                    var tp, vp;
                    if (thisObj.fixed) {
                    ...
                    if (!thisObj.smartPosition) var pp = [
                        tp[a],
                        tp[b] + ts[b] - l + l * c
                    ];
                    else var pp = [
            ...
            getPickerDims: function(thisObj) {
                ...
                if (pal.height) h += pal.height + thisObj.padding;
            ...
            triggerCallback: function(thisObj, prop) {
                if (!thisObj[prop]) return; // callback func not specified
                var callback = null;
                if (typeof thisObj[prop] === "string") // string with code
                try {
            ...
            triggerGlobal: function(eventNames) {
                ...
                for(var i = 0; i < inst.length; i += 1)inst[i].trigger(eventNames);
            },
            _pointerMoveEvent: {
                mouse: "mousemove",
                touch: "touchmove"
            ...
            onDocumentKeyUp: function(e) {
                if ([
                    "Tab",
                    "Escape"
                ].indexOf(jsc.eventKey(e)) !== -1) {
                    if (jsc.picker && jsc.picker.owner) jsc.picker.owner.tryHide();
                }
            },
            ...
            onDocumentMouseDown: function(e) {
                ...
                if (target.jscolor && target.jscolor instanceof jsc.pub) {
                    if (target.jscolor.showOnClick && !target.disabled) target.jscolor.show();
                } else if (jsc.getData(target, "gui")) {
                    var control = jsc.getData(target, "control");
                    if (control) // jscolor's control
                    jsc.onControlPointerStart(e, target, jsc.getData(target, "control"), "mouse");
                } else // mouse is outside the picker's controls -> hide the color picker!
                if (jsc.picker && jsc.picker.owner) jsc.picker.owner.tryHide();
            },
            onPickerTouchStart: function(e) {
                var target = e.target || e.srcElement;
                if (jsc.getData(target, "control")) jsc.onControlPointerStart(e, target, jsc.getData(target, "control"), "touch");
            },
            onControlPointerStart: function(e, target, controlName, pointerType) {
                ...
                registerDragEvents(window1.document, [
                    0,
                    0
                ]);
                if (window1.parent && window1.frameElement) {
                    var rect = window1.frameElement.getBoundingClientRect();
                    var ofs = [
                        -rect.left,
                        -rect.top
                    ];
                    registerDragEvents(window1.parent.window.document, ofs);
                }
            ...
            onPaletteSampleClick: function(e) {
                ...
                if (thisObj.format.toLowerCase() === "any") {
                    ...
                    if (!jsc.isAlphaFormat(thisObj.getFormat())) color.rgba[3] = 1.0; // when switching to a format that doesn't support alpha, set full opacity
                }
                // if this color doesn't specify alpha, use alpha of 1.0 (if applicable)
                if (color.rgba[3] === null) {
                    if (thisObj.paletteSetsAlpha === true || thisObj.paletteSetsAlpha === "auto" && thisObj._paletteHasTransparency) color.rgba[3] = 1.0;
                }
            ...
            setASld: function(thisObj, e, ofsY) {
                ...
                if (yVal < 1.0) {
                    ...
                    if (thisObj.format.toLowerCase() === "any" && !jsc.isAlphaFormat(fmt)) thisObj._setFormat(fmt === "hex" ? "hexa" : "rgba");
                }
            ...
            createASliderGradient: function() {
                ...
                var drawFunc = function(width, height, color) {
                    ...
                    ctx.fillStyle = sqColor1;
                    ctx.fillRect(0, 0, canvas.width, canvas.height);
                    if (sqSize > 0) for(var y = 0; y < canvas.height; y += sqSize * 2){
                        // light gray squares
                        ctx.fillStyle = sqColor2;
            ...
            pub: function(targetElement, opts) {
                ...
                this.option = function() {
                    ...
                    if (arguments.length === 1 && typeof arguments[0] === "string") {
                        ...
                        try {
                            if (!setOption(arguments[0], arguments[1])) return false;
                        } catch (e1) {
                            console.warn(e1);
                            return false;
                        }
                        ...
                        for(var opt in opts){
                            if (opts.hasOwnProperty(opt)) try {
                                if (!setOption(opt, opts[opt])) success = false;
                            } catch (e2) {
                                console.warn(e2);
                                success = false;
                            }
                ...
                //
                this.channel = function(name, value1) {
                    ...
                    if (value1 === undefined) {
                        ...
                        switch(name.toLowerCase()){
                            case "r":
                                res = this.fromRGBA(value1, null, null, null);
                                break;
                            case "g":
                                res = this.fromRGBA(null, value1, null, null);
                                break;
                            case "b":
                                res = this.fromRGBA(null, null, value1, null);
                                break;
                            case "h":
                                res = this.fromHSVA(value1, null, null, null);
                                break;
                            case "s":
                                res = this.fromHSVA(null, value1, null, null);
                                break;
                            case "v":
                                res = this.fromHSVA(null, null, value1, null);
                                break;
                            case "a":
                                res = this.fromHSVA(null, null, null, value1);
                                break;
                            default:
                ...
                this.fromString = function(str, flags) {
                    ...
                    if (!color) return false; // could not parse
                    if (this.format.toLowerCase() === "any") {
                        this._setFormat(color.format); // adapt format
                        if (!jsc.isAlphaFormat(this.getFormat())) color.rgba[3] = 1.0; // when switching to a format that doesn't support alpha, set full opacity
                    }
                ...
                this.toString = function(format) {
                    if (format === undefined) format = this.getFormat(); // format not specified -> use the current format
                    switch(format.toLowerCase()){
                        case "hex":
                ...
                this.hide = function() {
                    if (isPickerOwner()) detachPicker();
                };
                this.show = function() {
                    drawPicker();
                };
                this.redraw = function() {
                    if (isPickerOwner()) drawPicker();
                };
                ...
                this.hasAlphaChannel = function() {
                    if (this.alphaChannel === "auto") return this.format.toLowerCase() === "any" || // format can change on the fly (e.g. from hex to rgba), so let's consider the alpha channel enabled
                ...
                this.processValueInput = function(str) {
                    if (!this.fromString(str)) // could not parse the color value - let's just expose the current color
                    this.exposeColor();
                };
                this.processAlphaInput = function(str) {
                    if (!this.fromHSVA(null, null, null, parseFloat(str))) // could not parse the alpha value - let's just expose the current color
                    this.exposeColor();
                };
                ...
                this.setPreviewElementBg = function(color) {
                    ...
                    var backgrounds = [];
                    if (!color) // there is no color preview to display -> let's remove any previous background image
                    backgrounds.push({
                        image: "none",
                        position: "left top",
                        size: "auto",
                ...
                this.setValueElementValue = function(str) {
                    if (this.valueElement) {
                        if (jsc.nodeName(this.valueElement) === "input") this.valueElement.value = str;
                        else this.valueElement.innerHTML = str;
                    }
                };
                this.setAlphaElementValue = function(str) {
                    if (this.alphaElement) {
                        if (jsc.nodeName(this.alphaElement) === "input") this.alphaElement.value = str;
                        else this.alphaElement.innerHTML = str;
                    }
                };
                this._processParentElementsInDOM = function() {
                    ...
                    do {
                        ...
                        if (elm !== this.targetElement) // Ensure to attach onParentScroll only once to each parent element
                ...
                function setOption(option, value1) {
                    ...
                    if (jsc.enumOpts.hasOwnProperty(option)) {
                        ...
                        if (jsc.enumOpts[option].indexOf(value1) === -1) throw new Error("Option '" + option + "' has invalid value: " + value1);
                    }
                    // deprecated option
                    if (jsc.deprecatedOpts.hasOwnProperty(option)) {
                        ...
                        if (newOpt) {
                            ...
                            option = newOpt;
                        } else // new name not available for the option
                ...
                function getOption(option) {
                    ...
                    if (typeof THIS[getter] === "function") return THIS[getter](value);
                    else if (option in THIS) return THIS[option];
                    throw new Error("Unrecognized configuration option: " + option);
                }
                ...
                function drawPicker() {
                    ...
                    p.padM.style.left = "0px";
                    p.padM.style.top = "0px";
                    ...
                    for(var r = 0; r < pickerDims.palette.rows; r++)for(var c = 0; c < pickerDims.palette.cols && si < THIS._palette.length; c++, si++){
                ...
                function onValueChange(ev) {
                    if (jsc.getData(ev, "internal")) return; // skip if the event was internally triggered by jscolor
                    var oldVal = THIS.valueElement.value;
                    THIS.processValueInput(THIS.valueElement.value); // this might change the value
                    jsc.triggerCallback(THIS, "onChange");
                    if (THIS.valueElement.value !== oldVal) // value was additionally changed -> let's trigger the change event again, even though it was natively dispatched
                ...
                function onAlphaChange(ev) {
                    ...
                    jsc.triggerInputEvent(THIS.valueElement, "change", true, true);
                    if (THIS.alphaElement.value !== oldVal) // value was additionally changed -> let's trigger the change event again, even though it was natively dispatched
                ...
                if (jsc.pub.options) // let's set custom default options, if specified
                ...
                var presetsArr = [];
                if (opts.preset) {
                    if (typeof opts.preset === "string") presetsArr = opts.preset.split(/\s+/);
                    else if (Array.isArray(opts.preset)) presetsArr = opts.preset.slice(); // slice() to clone
                    else console.warn("Unrecognized preset value");
                }
                ...
                for(var i = presetsArr.length - 1; i >= 0; i -= 1){
                    ...
                    if (!pres) continue; // preset is empty string
                ...
                for(var opt in opts)if (opts.hasOwnProperty(opt)) {
                    if (nonProperties.indexOf(opt) === -1) try {
                ...
                if (this.container === undefined) this.container = window1.document.body; // default container is BODY element
                else this.container = jsc.node(this.container);
                ...
                if (jsc.isButton(this.targetElement)) {
                    if (this.targetElement.type.toLowerCase() !== "button") // on buttons, always force type to be 'button', e.g. in situations the target <button> has no type
                    ...
                    if (jsc.isButtonEmpty(this.targetElement)) {
                        ...
                        this.targetElement.appendChild(window1.document.createTextNode("\xa0"));
                        // set min-width = previewSize, if not already greater
                        var compStyle = jsc.getCompStyle(this.targetElement);
                        var currMinWidth = parseFloat(compStyle["min-width"]) || 0;
                        if (currMinWidth < this.previewSize) jsc.setStyle(this.targetElement, {
                ...
                if (this.valueElement === undefined) {
                    if (jsc.isTextInput(this.targetElement)) // for text inputs, default valueElement is targetElement
                    this.valueElement = this.targetElement;
                // leave it undefined
                } else if (this.valueElement === null) ;
                else this.valueElement = jsc.node(this.valueElement);
                // Determine the alpha element
                if (this.alphaElement) this.alphaElement = jsc.node(this.alphaElement);
                // Determine the preview element
                if (this.previewElement === undefined) this.previewElement = this.targetElement; // default previewElement is targetElement
                else if (this.previewElement === null) ;
                else this.previewElement = jsc.node(this.previewElement);
                // valueElement
                ...
                if (this.value !== undefined) initValue = this.value; // get initial color from the 'value' property
                else if (this.valueElement && this.valueElement.value !== undefined) initValue = this.valueElement.value; // get initial color from valueElement's value
                // determine initial alpha value
                //
                var initAlpha = undefined;
                if (this.alpha !== undefined) initAlpha = "" + this.alpha; // get initial alpha value from the 'alpha' property
                else if (this.alphaElement && this.alphaElement.value !== undefined) initAlpha = this.alphaElement.value; // get initial color from alphaElement's value
                ...
                if ([
                    "auto",
                    "any"
                ].indexOf(this.format.toLowerCase()) > -1) {
                    // format is 'auto' or 'any' -> let's auto-detect current format
                    var color = jsc.parseColorString(initValue);
                    this._currentFormat = color ? color.format : "hex";
                } else // format is specified
                ...
                if (this.random) // randomize the initial color value
        ...
        jsc.pub.init = function() {
            ...
            window1.document.addEventListener("mousedown", jsc.onDocumentMouseDown, false);
            window1.document.addEventListener("keyup", jsc.onDocumentKeyUp, false);
            window1.addEventListener("resize", jsc.onWindowResize, false);
            window1.addEventListener("scroll", jsc.onWindowScroll, false);
        ...
        jsc.pub.ready = function(func) {
            ...
            if (jsc.initialized) func();
            else jsc.readyQueue.push(func);
            return true;
        };
        ...
        jsc.pub.trigger = function(eventNames) {
            ...
            if (jsc.initialized) triggerNow();
            else jsc.pub.ready(triggerNow);
        };
        // Hides current color picker box
        jsc.pub.hide = function() {
            if (jsc.picker && jsc.picker.owner) jsc.picker.owner.hide();
        };
    ...
    if (typeof window1.jscolor === "undefined") window1.jscolor = window1.JSColor = jscolor;
    // END jscolor code
    return jscolor;
}); // END factory
...
class Sidebar {
    ...
    get template() {
        return [
            (0, _utils.TitleHTML)("title"),
            (0, _utils.TextHTML)("text"),
            (0, _utils.ColumnsHTML)("columns")
        ];
    }
    add(event) {
        ...
        if (type === "title") {
            ...
            const tag = [
                ...event.target.tag
            ].find((i)=>i.checked === true).id;
            const textAlign = [
                ...event.target["text-align"]
            ].find((i)=>i.checked === true).id;
            ...
            newBlock = new (0, _blocks.TitleBlock)(value, {
                tag,
                styles,
                fz
            });
            ...
            const value1 = event.target.value.value;
            const fontSize1 = event.target["font-size"].value == "" ? 16 : event.target["font-size"].value;
            const background1 = event.target.background.value;
            const color1 = event.target.color.value;
            const styles1 = {
                "font-size": fontSize1 + "px",
                background: background1,
                color: color1
            };
            newBlock = new (0, _blocks.TextBlock)(value1, {
                styles: styles1
            });
            event.target.value.value = "";
        } else if (type === "columns") {
            const value11 = event.target.value1.value;
            ...
            const fontSize2 = event.target["font-size"].value == "" ? 16 : event.target["font-size"].value;
            const background2 = event.target.background.value;
            const color2 = event.target.color.value;
            const value6 = [];
            value11 && value6.push(value11);
            value2 && value6.push(value2);
            value3 && value6.push(value3);
            value4 && value6.push(value4);
            value5 && value6.push(value5);
            const styles2 = {
                padding: "20px",
            ...
            newBlock = new (0, _blocks.ColumnsBlock)(value6, {
                styles: styles2
            });
